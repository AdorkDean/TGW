...
-(CustomNavigationBarView *)layoutNaviBarViewWithUIAndTitle:(NSString *)title{
    // 设置状态栏字体颜色为白色
    barStyle = UIStatusBarStyleLightContent;
...
-(CustomNavigationBarView *)layoutNaviBarViewWithTitle:(NSString *)title{
    ...
    int iHeight = navBarView.height;
    UIView *viewFG = [[UIView alloc] initWithFrame:CGRectMake(0, iHeight-1, SCREEN_WIDTH, 1)];
    [navBarView addSubview:viewFG];
