...
-(void)getCityData{
    ...
    //NSString *url = [NSString stringWithFormat:@"%@%@",[PDAPI getBusiUrlString],@"busi/area/allAreaInfo"];
    NSString *url = [NSString stringWithFormat:@"%@%@",[PDAPI getBusiUrlString],kDDGallAreaInfo];
