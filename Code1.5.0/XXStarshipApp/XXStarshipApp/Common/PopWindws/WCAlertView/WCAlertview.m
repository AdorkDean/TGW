...
-(void)setUp2{
    ...
    UIView * keywindow = [[UIApplication sharedApplication] keyWindow];
    self.alertview.center = CGPointMake(CGRectGetMidX(keywindow.frame), -CGRectGetMidY(keywindow.frame));
    self.alertview.backgroundColor = [UIColor clearColor]; //UIColorFromRGB11(0xfefcfb);
    self.alertview.clipsToBounds = YES;
    ...
    UILabel *labelTitle = [[UILabel alloc] initWithFrame:CGRectMake(0, 115, 195, 30)];
    //[self.alertview addSubview:labelTitle];
    labelTitle.textAlignment = NSTextAlignmentRight;
    labelTitle.textColor = [UIColor whiteColor];
    labelTitle.font = [UIFont systemFontOfSize:23];
    labelTitle.text = @"发现新版本";
    
    self.buttonVesion = [[UIButton alloc] initWithFrame:CGRectMake(195+30,135-70, 50,18)];
    ...
    //self.buttonVesion.titleLabel.textColor = [ResourceManager mainColor];
    [self.buttonVesion setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    self.buttonVesion.titleLabel.textAlignment = NSTextAlignmentCenter;
    //self.buttonVesion.layer.cornerRadius = 8;
    //self.buttonVesion.backgroundColor = [UIColor whiteColor];
    [self.alertview addSubview:self.buttonVesion];

    
    UIView *viewOther = [[UIView alloc] initWithFrame:CGRectMake(0, imageviewHeight, alertviewWidth, 100)];
    [self.alertview addSubview:viewOther];
    ...
    viewOther.height = self.alertview.height - imageviewHeight;
}
