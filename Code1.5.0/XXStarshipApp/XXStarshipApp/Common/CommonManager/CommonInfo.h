...
#define  K_LABEL_KEY_ELEMENT @"K_Lable_Key_Element"  // 标记配置信息_Key
#define  K_WXQRCODEURL  @"K_WXQrCodeUrl"         // 客服微信二维码

#define  K_XCODE  @"K_XCODE"         // 和h5交互配合，隐藏singid
#define  K_CREDIT_WEIXING  @"K_Credit_WeiXing"         // 信用卡客服
...
//  是否 实名认证和工作认证
+ (BOOL) isGZRZannSMRZ:(UIView*) vc;

//  是否 实名认证
+ (BOOL) isSMRZ:(UIView*) vc;
