...
-(void)setUp2{
    ...
    // 加入底部的VIEW
    UIView * bottonView = [[UIView alloc] initWithFrame:CGRectMake(0,imageviewHeight-1, alertviewWidth,self.alertview.frame.size.height - imageviewHeight)];
    bottonView.backgroundColor = [UIColor whiteColor];//UIColorFromRGB11(0xfefcfb);
