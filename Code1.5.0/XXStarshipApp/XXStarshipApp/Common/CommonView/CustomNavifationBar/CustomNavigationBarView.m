...
//    _titleLab.font = [UIFont fontWithName:@"Helvetica-Bold" size:16];
    ...
    if (colorStyle == NavigationBarViewBackColorWhite) {
        ...
        _backdropImg = [[UIImageView alloc]initWithFrame:self.frame];
        [self addSubview:_backdropImg];
        _backdropImg.image = [UIImage imageNamed:@"naviBackdrop"];
        _backdropImg.userInteractionEnabled = YES;
