...
@interface TGMJ_VC ()<WKNavigationDelegate,WKScriptMessageHandler>
{
    NSString *shareUrl;
    NSString *shareTitle;
...
//    self.progressView = progressView;
    ...
    if (IOS8x) {
        ...
        WKWebView *wkWebView = [[WKWebView alloc] initWithFrame:CGRectMake(0, NavHeight, self.view.frame.size.width, self.view.frame.size.height - NavHeight - 50)  configuration:config];
        ...
        btnQuit.backgroundColor = [ResourceManager mainColor2];
