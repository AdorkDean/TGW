...
//    }
    ...
    NSString *strWX = [NSString stringWithFormat:@"如有任何疑问，请联系客服微信:  %@",dicUser[@"kfWeiXin"]];
    _labelNote.text = strWX;
    
//    天狗窝
//    
//    11738969
//    
//    AppID：APvVOdbxQYKbBpnSBWkSouC3
//    
//    API Key：eiirGQwHfBhyQ1Xzjong9TFweaGt8c34
//    文字识别


    //授权方法1：请在 http://ai.baidu.com中 新建App, 绑定BundleId后，在此处填写App的Api Key/Secret Key
    [[AipOcrService shardService] authWithAK:@"APvVOdbxQYKbBpnSBWkSouC3" andSK:@"eiirGQwHfBhyQ1Xzjong9TFweaGt8c34"];
    //[[AipOcrService shardService] authWithAK:@"WBqlRDjbd1NHw1gGTifWcGwH" andSK:@"ykBcuMKak4Fnrv2HFZyp3ExypDNzQwj2"];
...
- (IBAction)scanCardReverse:(UIButton *)sender {
    ...
    if (!_frontImgStr ||
        _frontImgStr.length <= 0)
     {
        [MBProgressHUD showErrorWithStatus:@"请先上传正面照" toView:self.view];
        return;
     }
