...
// 接口URL
static NSString *const kBaseURL = @"https://www.tiangouwo.com/"; //@"https://newapp.xxjr.com/";
...
// 版本检测
static NSString *const kDDGCheckVersionAPIString = @"tgw/app/version/upgradeInfo";
// 获取验证码
...
// 退出登录
static NSString *const kDDGUserDoLogoutAPIString = @"xxcust/logout";
...
static NSString *const kDDGGetUserInfoAPIString = @"busi/app/version/upgradeInfo";
...
// 个人认证
static NSString *const kDDGGetpersonalAuthInfoAPIString = @"xxcust/account/info/personalAuth";
// 机构列表
static NSString *const kDDGGetProfessionInfoAPIString =@"busi/company/queryCompanys";
// 添加公司
static NSString *const kDDGGetAddCompanyAPIString = @"busi/company/addCompany";

// 查询认证信息
static NSString *const kDDGGetQueryProfessionInfoAPIString = @"xxcust/account/query/personalAuthInfo";
...
// 服务区域
static NSString *const kDDGGetAllAreaInfoAPIString = @"area/allAreaInfo";
...
// 用户基本信息
static NSString *const kDDGGetUserBaseInfoAPIString = @"xxcust/account/query/getInfo";
// 修改个人信息
static NSString *const kDDGUserGetModifyInfoAPIString = @"xxcust/account/info/modifyInfo";
...
// 验证码登陆
static NSString *const kDDGUserKJLoginAPIString= @"xxcust/comm/app/xdjl/kjLogin";

// 密码登陆
static NSString *const kDDGUserPassWordLoginAPIString= @"xxcust/comm/app/xdjl/login";
...
#if DEBUG
//   return @"https://www.tiangouwo.com/";
//    return @"http://192.168.10.129:82/";  // 刘礼伟
//    return @"http://192.168.10.205/";      // 邹全洪
    return @"http://192.168.10.182/";        //  测试
//    return @"http://192.168.10.132/";    //  方然青
//    return @"http://192.168.10.131/";    //  黄木俊
//    return @"http://192.168.10.109/";    //  余应府
//    return @"http://192.168.10.142/";     //  陈传新
//    return @"http://192.168.10.133/";     //  赵松
//    return @"http://192.168.10.192:8080/";     //汤炜昌
